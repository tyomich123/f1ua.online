...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    publishedAte: Schema.Attribute.DateTime;
...
export interface ApiDriverDriver extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    standing: Schema.Attribute.Relation<'oneToOne', 'api::standing.standing'>;
...
export interface ApiRaceRace extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    circuit: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Example: "Yas Marina Circuit"'>;
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Example: "Abu Dhabi Grand Prix"'>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    statuss: Schema.Attribute.Enumeration<['upcoming', 'live', 'completed']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiStandingStanding extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    podiums: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    season: Schema.Attribute.Integer &
      ...
      >;
    team: Schema.Attribute.Relation<'oneToOne', 'api::team.team'>;
    type: Schema.Attribute.Enumeration<['driver', 'constructor']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    base: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Milton Keynes, UK'>;
    chassis: Schema.Attribute.String;
    ...
    driver: Schema.Attribute.Relation<'oneToOne', 'api::driver.driver'>;
    drivers: Schema.Attribute.Relation<'oneToMany', 'api::driver.driver'>;
    firstTeamEntry: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'2005'>;
    fullName: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::team.team'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    powerUnit: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'>;
    standing: Schema.Attribute.Relation<'oneToOne', 'api::standing.standing'>;
    teamChief: Schema.Attribute.String;
    technicalChief: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiVideoVideo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['highlights', 'interviews', 'must-watch', 'featured', 'technical']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    duration: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Example: "8:14"'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    relatedDrivers: Schema.Attribute.Relation<
      'oneToMany',
      'api::driver.driver'
    >;
    slug: Schema.Attribute.UID<'title'>;
